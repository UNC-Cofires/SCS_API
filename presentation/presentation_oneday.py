...
def plot_single_day_pph(storm_type, year, month, day):
    ...
    # FIXED PPH scale - meaningful thresholds in decimal form (15%, 30%, 45%, 60%, 70%)
    # These correspond to realistic severe weather probability thresholds
    pph_scale = [0.001, 0.15, 0.25, 0.4, 0.6, 1.0]
...
# Example usage - modified for April 3, 2014
if __name__ == "__main__":
    # April 3, 2014 - Significant severe weather outbreak day
    target_year = 2014
    target_month = 4
    target_day = 3
