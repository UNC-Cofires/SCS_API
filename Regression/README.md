...
All Data sources will be at the bottom and when a variable is introduced.
...
- BDD_Losses: If an event is BDD (1), records the losses of these events. Losses are reported in millions. Meaning, 2069.0 represents damages of 2.069.0 billion. If BDD was 0, then BDD_Losses will also show 0. This does not mean there were 0 dollars in damage, rather it did not meet the Billion Dollar threshold. For example, If a day had 500 million in damage, it would be excluded. 
